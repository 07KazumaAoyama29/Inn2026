...
<details><summary> input文とif文の練習 </summary>

- [STEP4 input文とif文を組み合わせよう](#STEP4-input文とif文を組み合わせよう)
- [STEP5 elifを使ってみよう](#STEP5-elifを使ってみよう)
- [STEP6 返事の種類を増やそう](#STEP6-返事の種類を増やそう)

</details>

- [Mission ミニ会話プログラムを作ろう](#Mission-ミニ会話プログラムを作ろう)
- [Ex 発展課題](#Ex-発展課題)
- [まとめ](#まとめ)
- [参考文献](#参考文献)
...
# プログラム全体図
- ①if文とelseを復習する<br>
- ②`==` は「同じかどうか」を調べる記号だと確認する<br>
- ③`input()` でキーボードから文字を受け取る<br>
- ④`input("文字")` で入力するときの案内文を表示する<br>
- ⑤input文とif文を組み合わせる<br>
- ⑥elifを使って、返事の種類を増やす<br>
- ⑦ミニ会話プログラムを作る<br>
